        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            ...
            <div className="flex flex-col gap-6 lg:grid lg:grid-cols-2">
              <Input.Root>
                <Input.Control id="firstName" defaultValue="Yago" />
              </Input.Root>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Input.Root>
              ...
              <Input.Control
                id="email"
                type="email"
                defaultValue="yagofer12@gmail.com"
              />
            </Input.Root>
          </div>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Select placeholder="Select a timezone...">
              <SelectItem value="utc8" text="Pacific Standard (UTC−08:00)" />
              <SelectItem value="utc3" text="American City (UTC−03:00)" />
            </Select>
          </div>
